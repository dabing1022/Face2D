    ...
    int       nCmdShow)
{
    ...
    return Face2d_xPlayer::createAndRun();
}

int Face2d_xPlayer::createAndRun(void)
{
    Face2d_xPlayer *host = Face2d_xPlayer::sharedInstance();
    int ret = host->run();
    Face2d_xPlayer::purgeSharedInstance();
    return ret;
}

Face2d_xPlayer *Face2d_xPlayer::s_sharedInstance = NULL;

Face2d_xPlayer *Face2d_xPlayer::sharedInstance(void)
{
    if (!s_sharedInstance)
    {
        s_sharedInstance = new Face2d_xPlayer();
    }
    return s_sharedInstance;
}

void Face2d_xPlayer::purgeSharedInstance(void)
{
    if (s_sharedInstance)
    {
...
Face2d_xPlayer::Face2d_xPlayer(void)
: m_app(NULL)
, m_hwnd(NULL)
, m_exit(TRUE)
...
int Face2d_xPlayer::run(void)
{
    ...
    do
    {
        ...
        SetWindowTextA(m_hwnd, "face2d_x-player");
...
void Face2d_xPlayer::loadProjectConfig(void)
{
    vector<string> args;
...
void Face2d_xPlayer::createViewMenu(void)
{
...
void Face2d_xPlayer::updateMenu(void)
{
    HMENU menu = GetMenu(m_hwnd);
    HMENU viewMenu = GetSubMenu(menu, 1);
...
void Face2d_xPlayer::updateWindowTitle(void)
{
}

void Face2d_xPlayer::relaunch(void)
{
...
void Face2d_xPlayer::writeDebugLog(const char *log)
{
...
// menu callback
void Face2d_xPlayer::onFileOpenProject(void)
{
...
void Face2d_xPlayer::onFileCreateProjectShortcut(void)
{
    ...
    if (SUCCEEDED(hres))
    {
        ...
        psl->SetDescription(L"Face2d_xPlayer");
...
void Face2d_xPlayer::onFileProjectConfig(void)
{
...
void Face2d_xPlayer::onFileRelaunch(void)
{
    relaunch();
}

void Face2d_xPlayer::onFileExit(void)
{
    DestroyWindow(m_hwnd);
}

void Face2d_xPlayer::onViewChangeFrameSize(int viewMenuID)
{
...
void Face2d_xPlayer::onViewChangeOrientation(int viewMenuID)
{
    bool isLandscape = m_project.isLandscapeFrame();
...
void Face2d_xPlayer::onViewChangeZoom(int scaleMode)
{
    float scale = 1.0f;
...
void Face2d_xPlayer::onHelpAbout(void)
{
    DialogBox(GetModuleHandle(NULL), MAKEINTRESOURCE(IDD_ABOUTBOX), m_hwnd, AboutDialogCallback);
}

// windows callback
LRESULT Face2d_xPlayer::WindowProc(UINT message, WPARAM wParam, LPARAM lParam, BOOL* pProcessed)
{
    int wmId, wmEvent;
    Face2d_xPlayer *host = Face2d_xPlayer::sharedInstance();
...
INT_PTR CALLBACK Face2d_xPlayer::AboutDialogCallback(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
